...
call:_colcon_prefix_chain_bat_call_script "E:\dev\ros2_foxy\local_setup.bat"
call:_colcon_prefix_chain_bat_call_script "E:\dev\ros2_foxy\\local_setup.bat"
call:_colcon_prefix_chain_bat_call_script "E:\Projects\AUV\DROPLAB\ros_ws\install\\local_setup.bat"
