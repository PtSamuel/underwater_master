...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joystick_publisher\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joystick_publisher\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joystick_publisher\hook\ament_prefix_path.bat"
