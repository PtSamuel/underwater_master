...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\flir_subscriber\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\flir_subscriber\hook\ament_prefix_path.bat"
